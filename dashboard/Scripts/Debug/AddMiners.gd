...
func add1():
	for i in range($SpinBox1.value):
		game_controller.add_miner(true, Global.MinerType.MINER1);


func add2():
	for i in range($SpinBox2.value):
		game_controller.add_miner(true, Global.MinerType.MINER2);


func add3():
	for i in range($SpinBox3.value):
		game_controller.add_miner(true, Global.MinerType.MINER3);
